...
(async function RESTfulFetchExample() {
	...
	try {
		...
		const data = await res.json();
		console.log(timedMsg('response' + exampleStep2), data);
	} catch (err) {
		console.log(timedMsg('response' + exampleStep2), err);
	}
	...
	try {
		...
		const res = await fetch('/todos?id=1');
		const data = await res.json();
		console.log(timedMsg('response' + exampleStep3), data);
	} catch (err) {
		console.log(timedMsg('response' + exampleStep3), err);
	}
	...
	try {
		...
		const res = await fetch('/todos?todoText=' + bodyQuery);
		const data = await res.json();
		console.log(timedMsg('response' + exampleStep4), data);
	} catch (err) {
		console.log(timedMsg('response' + exampleStep4), err);
	}
	...
	try {
		...
		const data = await res.json();
		console.log(timedMsg('response' + exampleStep6), data);
	} catch (err) {
		console.log(timedMsg('response' + exampleStep6), err);
	}
	...
	try {
		...
		const data = res.json();
		console.log(timedMsg('response' + exampleStep8), data);
	} catch (err) {
		console.log(timedMsg('response' + exampleStep8), err);
	}
	...
	try {
		...
		for (let i = 1; i <= 7; i++) {
			...
			const data = res.json();
			console.log(timedMsg('response' + randomTodoMsg), data);
		}
	} catch (err) {
		console.log(timedMsg('response' + randomTodoMsg), err);
	}
	...
	try {
		...
		const res = await fetch('/todos/5', {
			method: 'DELETE'
		});
		const data = await res.json();
		console.log(timedMsg('response' + exampleStep10), data);
	} catch (err) {
		console.log(timedMsg('response' + exampleStep10), err);
	}
	...
	try {
		...
		const data = await res.json();
		console.log(timedMsg('response' + exampleStep11), data);
	} catch (err) {
		console.log(timedMsg('response' + exampleStep11), err);
	}
	...
	try {
		...
		const res = await fetch('/todos?completed=true');
		const data = await res.json();
		console.log(timedMsg('response' + exampleStep12), data);
	} catch (err) {
		console.log(timedMsg('response' + exampleStep12), err);
	}
})();
